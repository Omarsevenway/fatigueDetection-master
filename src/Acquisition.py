...
class Acquisition(threading.Thread):
    ...
    def run(self):
        ...
        files = glob.glob(r'C:\Users\oazougagh\Desktop\Test\acquisition.py\frames\*')
        for f in files:
            os.remove(f)
        ...
        while self.running:
            ...
            #cv2.imwrite(r"C:\Users\oazougagh\Desktop\Test\acquisition.py\frames\test.png", frame)
            # print(frame)
